    ...
    >
      ...
      <nav className="bg-white border-b h-20 flex items-center w-full">
        <div className="container mx-auto px-4 max-w-7xl w-full">
          <a href="/heat-treatment-furnaces">
            <Image
              src={LOGO_URL}
          ...
          <div className="pt-6 border-t space-y-6">
            <div className="flex justify-center">
              <Button asChild variant="outline" className="gap-2 border-primary text-white">
                <a href="/heat-treatment-furnaces" className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-md text-sm font-medium">
